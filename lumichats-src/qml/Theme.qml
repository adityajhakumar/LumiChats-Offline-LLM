...
QtObject {
    ...
    // green
    property color orange50: Qt.hsla(25/360, 0.18, 0.97)
    property color orange100: Qt.hsla(25/360, 0.21, 0.93)
    property color orange200: Qt.hsla(25/360, 0.21, 0.85)
    property color orange300: Qt.hsla(25/360, 0.20, 0.73)
    property color orange400: Qt.hsla(25/360, 0.19, 0.58)
    property color orange500: Qt.hsla(25/360, 0.19, 0.45)
    property color orange600: Qt.hsla(25/360, 0.20, 0.33)
    property color orange700: Qt.hsla(25/360, 0.19, 0.29)
    property color orange800: Qt.hsla(25/360, 0.17, 0.24)
    property color orange900: Qt.hsla(25/360, 0.17, 0.20)
    property color orange950: Qt.hsla(25/360, 0.22, 0.10)
    property color orange300_sat: Qt.hsla(25/360, 0.24, 0.73)
    property color orange400_sat: Qt.hsla(25/360, 0.23, 0.58)
    property color orange450_sat: Qt.hsla(25/360, 0.23, 0.52)
    ...
    property color mediumButtonBackgroundHovered: {
        switch (MySettings.chatTheme) {
            case MySettingsEnums.ChatTheme.LegacyDark:
                return purple450
            case MySettingsEnums.ChatTheme.Dark:
                return orange450_sat
            default:
                return orange300_sat
        }
    }
